...
import { getMsalInstance, getMsalRedirectUri, ensureMsalAccount } from '../services/msalInstance.js'
...
export function AuthProvider({ children }) {
  ...
  return (
    <AuthContext.Provider value={{ sessionEmployee, setSessionEmployee, logout }}>
      {children}
