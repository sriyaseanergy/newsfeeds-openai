...
def user_to_response(user: AuthenticatedUser) -> EmployeeResponse:
    return EmployeeResponse(
        ...
        can_manage_feed_sources=user.is_admin,
    )
...
class AuthService:
    ...
    def create_session(self, id_token: str) -> SessionResponse:
        ...
        return SessionResponse(employee=user_to_response(user))
